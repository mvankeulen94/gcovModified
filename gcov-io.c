...
/* This section consists of functions designed to manipulate
...
void add_to_int_data (struct intermediate_data *list, const char *key, const void *value,
    ...
    struct intermediate_record *new_int_record = (struct intermediate_record *) xmalloc(sizeof(struct intermediate_record));
    ...
    new_int_record->key = (char *) xmalloc(strlen(key) + 3);
    ...
    if (strcmp(new_int_record->type, "long") == 0) {
        new_int_record->value = xmalloc(sizeof(long));
        *((long *) new_int_record->value) = *(const long *)value;
    }

    if (strcmp(new_int_record->type, "string") == 0) {
        new_int_record->value = xmalloc(strlen((const char *) value) + 3);
    ...
    if (strcmp(new_int_record->type, "array") == 0 ||
        ...
        new_int_record->value = xmalloc(sizeof(struct intermediate_data));
    ...
    if (strcmp(new_int_record->type, "char") == 0) {
        new_int_record->value = xmalloc(sizeof(char));
        *((char *) new_int_record->value) = *(const char *)value;
    }

    if (strcmp(new_int_record->type, "unsigned") == 0) {
        new_int_record->value = xmalloc(sizeof(unsigned));
